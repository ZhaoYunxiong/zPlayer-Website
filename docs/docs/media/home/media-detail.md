...
已有对应播放记录时，点击“观看历史”进入独立的[作品观看详情](/docs/media/history/work-details)，查看累计时长、播放次数、观看天数、来源、分季进度和逐次播放明细。没有记录时，入口显示“暂无观看记录”；单纯浏览本页不会新增播放记录。

从作品观看详情点击“作品详情”可以回到媒体资料。在这两个页面之间往返时，会优先返回已经打开的对应页面，保留浏览上下文，避免重复叠加返回层级。
